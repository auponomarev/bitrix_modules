...
class CheckListTable extends Entity\DataManager
{
	/**
	...
	public static function getMap()
	{
		return array(
			'ID' => array(
				...
				'primary' => true,
				'autocomplete' => true,
				'title' => Loc::getMessage('TEMPLATE_CHECKLIST_ITEM_ITEM_ENTITY_ID_FIELD'),
			),
			'TEMPLATE_ID' => array(
				'data_type' => 'integer',
				'required' => true,
				'title' => Loc::getMessage('TEMPLATE_CHECKLIST_ITEM_ITEM_ENTITY_TEMPLATE_ID_FIELD'),
			),
			'SORT' => array(
				'data_type' => 'integer',
				'title' => Loc::getMessage('TEMPLATE_CHECKLIST_ITEM_ITEM_ENTITY_SORT_FIELD'),
			),
			'TITLE' => array(
				'data_type' => 'string',
				'required' => true,
				'validation' => array(__CLASS__, 'validateTitle'),
				'title' => Loc::getMessage('TEMPLATE_CHECKLIST_ITEM_ITEM_ENTITY_TITLE_FIELD'),
			),
			'CHECKED' => array(
				'data_type' => 'boolean',
				'default' => false,
				'title' => Loc::getMessage('TEMPLATE_CHECKLIST_ITEM_ITEM_ENTITY_CHECKED_FIELD'),
			),
...
/**
 * Class CheckListItemTable
 * @package Bitrix\Tasks\Template
 * @deprecated
 */
class CheckListItemTable extends CheckListTable {};