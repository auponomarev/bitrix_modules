...
<div class="ui-sidepanel-sidebar">
	...
	<div class="main-ui-filter-search main-ui-filter-theme-default main-ui-filter-set-inside" id="intranet-settings-search-container">
		<input type="text" tabindex="1" value="" name="FIND" placeholder="<?=Loc::getMessage('INTRANET_SETTINGS_SEARCH_PLACEHOLDER')?>" class="main-ui-filter-search-filter" id="intranet-settings-search" autocomplete="off">
