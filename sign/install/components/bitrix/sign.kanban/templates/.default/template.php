...
$stubPhoneImagePath = \Bitrix\Main\Application::getInstance()->getLicense()->getRegion() === 'ru'
...
$getStubTemplate = static function () use ($signMasterOpenLink, $openSignHelpdeskCode, $stubPhoneImagePath, $arParams): string {
	ob_start();
	?>
			...
			<div class="sign-kanban-stub--info-text-container">
				<div class="sign-kanban-stub--info-text--header-container">
					<div class="sign-kanban-stub__text-info--header-title">
						<?= htmlspecialcharsbx(Loc::getMessage('SIGN_KANBAN_STUB_HEADER_TITLE')) ?>
					</div>
				...
				<div class="sign-kanban-stub__text-info--info-block-content">
					...
					<div class="sign-kanban__text-info--footer">
						<?= htmlspecialcharsbx(Loc::getMessage('SIGN_KANBAN_STUB_BODY_FOOTER')) ?>
					</div>
