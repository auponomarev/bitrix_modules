...
(function (exports,main_core,main_loader) {
	...
	class Preview {
	  ...
	  getLayout() {
		...
		`), babelHelpers.classPrivateFieldLooseBase(this, _createContent)[_createContent](), babelHelpers.classPrivateFieldLooseBase(this, _controls)[_controls]);
	    babelHelpers.classPrivateFieldLooseBase(this, _render)[_render]();
	    return layout;
	  }
	  set urls(urls) {
	    babelHelpers.classPrivateFieldLooseBase(this, _urls)[_urls] = urls;
	...
	function _getImageLayout2(block) {
	  ...
	  return main_core.Tag.render(_t6 || (_t6 = _`<img src="data:image;base64,${0}" />`), url);
	}
	function _getTextLayout2(block) {
	  ...
	  const span = main_core.Tag.render(_t7 || (_t7 = _`<span>${0}</span>`), text);
	  span.innerHTML = text.replaceAll('[br]', '<br />');
	  return span;
	}
	function _createContent2() {
	  const content = main_core.Tag.render(_t8 || (_t8 = _`
			<div class="sign-preview__content">
				${0}
				${0}
				${0}
			</div>
		`), babelHelpers.classPrivateFieldLooseBase(this, _placeholder)[_placeholder], babelHelpers.classPrivateFieldLooseBase(this, _page)[_page], babelHelpers.classPrivateFieldLooseBase(this, _blocksContainer)[_blocksContainer]);
	  babelHelpers.classPrivateFieldLooseBase(this, _loader)[_loader].setOptions({
	    target: content,
	    size: 80
	  });
	  return content;
	...
	function _renderContent2() {
	  ...
	  if (babelHelpers.classPrivateFieldLooseBase(this, _urls)[_urls].length === 0) {
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _page)[_page].style.transform = '';
	    babelHelpers.classPrivateFieldLooseBase(this, _placeholder)[_placeholder].play();
	    return;
	  }
	  ...
	  babelHelpers.classPrivateFieldLooseBase(this, _page)[_page].style.transform = `scale(${babelHelpers.classPrivateFieldLooseBase(this, _scale)[_scale]})`;
	}
	...
	function _renderZoom2() {
	  ...
	  if (babelHelpers.classPrivateFieldLooseBase(this, _scale)[_scale] !== 1) {
	    main_core.Dom.addClass(babelHelpers.classPrivateFieldLooseBase(this, _page)[_page].parentElement, '--overflowed');
	    ...
	    main_core.Dom.removeClass(babelHelpers.classPrivateFieldLooseBase(this, _page)[_page].parentElement, '--overflowed');
	  }
	}
