...
class BlankService
{
	 ...
	 */
	public function createFromFile(FileCollection $fileCollection): AddResult
	{
		...
		$blank = $this->blankRepository->add(
			new Blank($firstFile->name, new FileCollection($firstFile))
		);
	 ...
	 */
	public function createFromFileIds(array $files): AddResult
	{
		...
		return $this->createFromFile($fileCollection);
	}
