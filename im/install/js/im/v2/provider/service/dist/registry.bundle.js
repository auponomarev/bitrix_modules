...
(function (exports,im_v2_provider_service,im_v2_lib_layout,im_v2_lib_uuid,im_public,ui_vue3_vuex,ui_notification,main_core,im_v2_lib_user,rest_client,im_v2_lib_utils,main_core_events,ui_uploader_core,im_v2_lib_logger,im_v2_lib_rest,im_v2_application_core,im_v2_const) {
	'use strict';
	...
	class SendingService$$1 {
	  ...
	  async sendMessage(params) {
	    ...
	    const sendResult = await babelHelpers.classPrivateFieldLooseBase(this, _sendMessageToServer)[_sendMessageToServer](message).catch(errors => {
	      ...
	      babelHelpers.classPrivateFieldLooseBase(this, _logSendErrors)[_logSendErrors](errors, 'sendMessage');
	    });
	    im_v2_lib_logger.Logger.warn('SendingService: sendMessage result -', sendResult);
	    const {
	      id
	    } = sendResult;
	    if (!id) {
	  ...
	  async retrySendMessage(params) {
	    ...
	    const sendResult = await babelHelpers.classPrivateFieldLooseBase(this, _sendMessageToServer)[_sendMessageToServer](message).catch(errors => {
	      babelHelpers.classPrivateFieldLooseBase(this, _updateMessageError)[_updateMessageError](message.temporaryId);
	      babelHelpers.classPrivateFieldLooseBase(this, _logSendErrors)[_logSendErrors](errors, 'retrySendMessage');
	    });
	    im_v2_lib_logger.Logger.warn('SendingService: retrySendMessage result -', sendResult.data());
	    const {
	      id
	    } = sendResult.data();
	    if (!id) {
	...
	function _tryToSendMessages2(uploaderId) {
	  ...
	  messagesToSend.forEach(message => {
	    babelHelpers.classPrivateFieldLooseBase(this, _sendingService)[_sendingService].sendMessageWithFile(message);
	  });
...
}((this.BX.Messenger.v2.Provider.Service = this.BX.Messenger.v2.Provider.Service || {}),BX.Messenger.v2.Provider.Service,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Vue3.Vuex,BX,BX,BX.Messenger.v2.Lib,BX,BX.Messenger.v2.Lib,BX.Event,BX.UI.Uploader,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Application,BX.Messenger.v2.Const));
