...
$MESS["CRM_TIMELINE_ITEM_EDITABLE_DESCRIPTION_SHOW"] = "Показать полностью";
$MESS["CRM_TIMELINE_ITEM_EDITABLE_DESCRIPTION_HIDE"] = "Скрыть текст";
...
$MESS["CRM_TIMELINE_ITEM_ACTIVITY_POPUP_TITLE_MSGVER_1"] = "Подписание";
$MESS["CRM_TIMELINE_ITEM_ACTIVITY_DO_USE_PREVIOUS_MSGVER_1"] = "Этот шаблон использовался %CREATED_AT% для сделки \"%TITLE%\", ответственный \"%INITIATOR%\". Использовать снова?";
$MESS["CRM_TIMELINE_ITEM_ACTIVITY_OLD_BUTTON_MSGVER_1"] = "Использовать снова";
$MESS["CRM_TIMELINE_ITEM_ACTIVITY_NEW_BUTTON_MSGVER_1"] = "Другой шаблон";
